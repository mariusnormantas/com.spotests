...
import * as sc from "./DashboardAthleteVisualizationPanel.styled";

const _DashboardAthleteVisualizationPanel: React.FC = () => {
...
export const DashboardAthleteVisualizationPanel = React.memo(
  _DashboardAthleteVisualizationPanel
);
DashboardAthleteVisualizationPanel.displayName =
  "@/pages/DashboardAthleteVisualizationPanel";
